...
export default function Contact() {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
        .sendForm('service_tn7s1ir', 'template_12a2rlv', formRef.current, {
            publicKey: 'WqreFDvTyIwvNAeG9',
        })
        .then(
            () => {
                setSuccess(true)
